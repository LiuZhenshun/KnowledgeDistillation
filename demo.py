...
def get_parser():
    ...
    parser.add_argument('--image', type=str, default='/home/msproject/LZS/kd/figure/demo/bochum_000000_000313_leftImg8bit.png', help='input image')
...
def main():
    ...
    if args.arch == 'psp':
        ...
        model = kd_model(classes=args.classes)
    elif args.arch == 'psa':
